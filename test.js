...
void async function () {
  ...
  const expected = [
    ...
    './readme.md:49 Recognize mutli-line single-line to-do comments',
    './readme.md:52 Do something',
    './readme.md:54 Do something else',
    './readme.md:60 Do a thing',
    './readme.md:64 Do a thing',
    './readme.md:69 Allow ignoring specific lines',
    './readme.md:73 Warn on unused ignore rules (maybe opt-in)',
